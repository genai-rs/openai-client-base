...
## [0.14.1](https://github.com/genai-rs/openai-client-base/compare/v0.14.0...v0.14.1) - 2026-07-20
...
- *(generate)* unblock client generation for the grown OpenAI spec

### Other

- *(deps)* Update astral-sh/setup-uv action to v8.3.0
- *(deps)* Update Rust crate anyhow to ^1.0.103
...
- *(deps)* Update github-actions to v8.2.0
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
...
## [0.11.0](https://github.com/genai-rs/openai-client-base/compare/v0.10.1...v0.11.0) - 2026-02-23

### Fixed

- remove impl Default from enums referencing non-Default types
- resolve 9 compilation errors in Generate Client workflow
- only hoist unions with complex types and use CamelCase names
- skip hoisting nullable wrapper unions (anyOf with null variant)
- hoist inline oneOf/anyOf into named schemas to prevent generator NPE
- auto-title unnamed oneOf/anyOf variants to prevent generator NullPointerException
...
## [0.10.1](https://github.com/genai-rs/openai-client-base/compare/v0.10.0...v0.10.1) - 2026-02-08
...
- automatically track and handle simplified type references

### Other

- Fix generation for string union variants
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
- *(deps)* Update Rust crate serde_with to ^3.16.1
- update generated client from latest OpenAPI spec
- Strip match arms for simplified schema variants
- Stop requiring yaml in fix_simplified_type_references
- Fix simplified schema tracking for generator
...
- add Rust 1.91.0 derivable_impls lint to allow list (genai-rs-42)
- normalize schema names with hyphens in OpenAPI spec (genai-rs-42)

### Other

- update generated client from latest OpenAPI spec
- update generated lib.rs with derivable_impls allow (genai-rs-42)
- *(deps)* Update rust patch updates
