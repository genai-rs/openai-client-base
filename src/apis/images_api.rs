...
#[bon::builder]
pub async fn create_image_edit(configuration: &configuration::Configuration, image: std::path::PathBuf, prompt: &str, mask: Option<std::path::PathBuf>, background: Option<&str>, model: Option<&str>, n: Option<i32>, size: Option<&str>, response_format: Option<&str>, output_format: Option<&str>, output_compression: Option<i32>, user: Option<&str>, input_fidelity: Option<models::ImageInputFidelity>, stream: Option<bool>, partial_images: Option<i32>, quality: Option<&str>) -> Result<models::ImagesResponse, Error<CreateImageEditError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
#[bon::builder]
pub async fn create_image_variation(configuration: &configuration::Configuration, image: std::path::PathBuf, model: Option<&str>, n: Option<i32>, response_format: Option<&str>, size: Option<&str>, user: Option<&str>) -> Result<models::ImagesResponse, Error<CreateImageVariationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_image = image;
    let p_form_model = model;
    let p_form_n = n;
