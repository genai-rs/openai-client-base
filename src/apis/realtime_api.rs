...
#[bon::builder]
pub async fn accept_realtime_call(configuration: &configuration::Configuration, call_id: &str, realtime_session_create_request_ga: models::RealtimeSessionCreateRequestGa) -> Result<(), Error<AcceptRealtimeCallError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_call_id = call_id;
    let p_body_realtime_session_create_request_ga = realtime_session_create_request_ga;

    let uri_str = format!("{}/realtime/calls/{call_id}/accept", configuration.base_path, call_id=crate::apis::urlencode(p_path_call_id));
...
#[bon::builder]
pub async fn create_realtime_call(configuration: &configuration::Configuration, sdp: &str, session: Option<models::RealtimeSessionCreateRequestGa>) -> Result<String, Error<CreateRealtimeCallError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_sdp = sdp;
...
#[bon::builder]
pub async fn create_realtime_client_secret(configuration: &configuration::Configuration, realtime_create_client_secret_request: models::RealtimeCreateClientSecretRequest) -> Result<models::RealtimeCreateClientSecretResponse, Error<CreateRealtimeClientSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
#[bon::builder]
pub async fn create_realtime_session(configuration: &configuration::Configuration, realtime_session_create_request: models::RealtimeSessionCreateRequest) -> Result<models::RealtimeSessionCreateResponse, Error<CreateRealtimeSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
#[bon::builder]
pub async fn create_realtime_transcription_session(configuration: &configuration::Configuration, realtime_transcription_session_create_request: models::RealtimeTranscriptionSessionCreateRequest) -> Result<models::RealtimeTranscriptionSessionCreateResponse, Error<CreateRealtimeTranscriptionSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_realtime_transcription_session_create_request = realtime_transcription_session_create_request;

    let uri_str = format!("{}/realtime/transcription_sessions", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateRealtimeTranscriptionSessionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn hangup_realtime_call(configuration: &configuration::Configuration, call_id: &str) -> Result<(), Error<HangupRealtimeCallError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_call_id = call_id;

    let uri_str = format!("{}/realtime/calls/{call_id}/hangup", configuration.base_path, call_id=crate::apis::urlencode(p_path_call_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
#[bon::builder]
pub async fn refer_realtime_call(configuration: &configuration::Configuration, call_id: &str, realtime_call_refer_request: models::RealtimeCallReferRequest) -> Result<(), Error<ReferRealtimeCallError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_call_id = call_id;
    let p_body_realtime_call_refer_request = realtime_call_refer_request;

    let uri_str = format!("{}/realtime/calls/{call_id}/refer", configuration.base_path, call_id=crate::apis::urlencode(p_path_call_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
#[bon::builder]
pub async fn reject_realtime_call(configuration: &configuration::Configuration, call_id: &str, realtime_call_reject_request: Option<models::RealtimeCallRejectRequest>) -> Result<(), Error<RejectRealtimeCallError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_call_id = call_id;
    let p_body_realtime_call_reject_request = realtime_call_reject_request;

    let uri_str = format!("{}/realtime/calls/{call_id}/reject", configuration.base_path, call_id=crate::apis::urlencode(p_path_call_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
