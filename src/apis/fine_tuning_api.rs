...
#[bon::builder]
pub async fn create_fine_tuning_checkpoint_permission(configuration: &configuration::Configuration, fine_tuned_model_checkpoint: &str, create_fine_tuning_checkpoint_permission_request: models::CreateFineTuningCheckpointPermissionRequest) -> Result<models::ListFineTuningCheckpointPermissionResponse, Error<CreateFineTuningCheckpointPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_fine_tuned_model_checkpoint = fine_tuned_model_checkpoint;
    let p_body_create_fine_tuning_checkpoint_permission_request = create_fine_tuning_checkpoint_permission_request;

    let uri_str = format!("{}/fine_tuning/checkpoints/{fine_tuned_model_checkpoint}/permissions", configuration.base_path, fine_tuned_model_checkpoint=crate::apis::urlencode(p_path_fine_tuned_model_checkpoint));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateFineTuningCheckpointPermissionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn delete_fine_tuning_checkpoint_permission(configuration: &configuration::Configuration, fine_tuned_model_checkpoint: &str, permission_id: &str) -> Result<models::DeleteFineTuningCheckpointPermissionResponse, Error<DeleteFineTuningCheckpointPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_fine_tuned_model_checkpoint = fine_tuned_model_checkpoint;
    let p_path_permission_id = permission_id;

    let uri_str = format!("{}/fine_tuning/checkpoints/{fine_tuned_model_checkpoint}/permissions/{permission_id}", configuration.base_path, fine_tuned_model_checkpoint=crate::apis::urlencode(p_path_fine_tuned_model_checkpoint), permission_id=crate::apis::urlencode(p_path_permission_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteFineTuningCheckpointPermissionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn list_fine_tuning_checkpoint_permissions(configuration: &configuration::Configuration, fine_tuned_model_checkpoint: &str, project_id: Option<&str>, after: Option<&str>, limit: Option<i32>, order: Option<&str>) -> Result<models::ListFineTuningCheckpointPermissionResponse, Error<ListFineTuningCheckpointPermissionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_fine_tuned_model_checkpoint = fine_tuned_model_checkpoint;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListFineTuningCheckpointPermissionsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn list_paginated_fine_tuning_jobs(configuration: &configuration::Configuration, after: Option<&str>, limit: Option<i32>, metadata: Option<std::collections::HashMap<String, String>>) -> Result<models::ListPaginatedFineTuningJobsResponse, Error<ListPaginatedFineTuningJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_after = after;
    let p_query_limit = limit;
...
#[bon::builder]
pub async fn pause_fine_tuning_job(configuration: &configuration::Configuration, fine_tuning_job_id: &str) -> Result<models::FineTuningJob, Error<PauseFineTuningJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_fine_tuning_job_id = fine_tuning_job_id;

    let uri_str = format!("{}/fine_tuning/jobs/{fine_tuning_job_id}/pause", configuration.base_path, fine_tuning_job_id=crate::apis::urlencode(p_path_fine_tuning_job_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
#[bon::builder]
pub async fn resume_fine_tuning_job(configuration: &configuration::Configuration, fine_tuning_job_id: &str) -> Result<models::FineTuningJob, Error<ResumeFineTuningJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_fine_tuning_job_id = fine_tuning_job_id;

    let uri_str = format!("{}/fine_tuning/jobs/{fine_tuning_job_id}/resume", configuration.base_path, fine_tuning_job_id=crate::apis::urlencode(p_path_fine_tuning_job_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Run a grader. 
#[bon::builder]
pub async fn run_grader(configuration: &configuration::Configuration, run_grader_request: models::RunGraderRequest) -> Result<models::RunGraderResponse, Error<RunGraderError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Validate a grader. 
#[bon::builder]
pub async fn validate_grader(configuration: &configuration::Configuration, validate_grader_request: models::ValidateGraderRequest) -> Result<models::ValidateGraderResponse, Error<ValidateGraderError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_grader_request = validate_grader_request;

    let uri_str = format!("{}/fine_tuning/alpha/graders/validate", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
