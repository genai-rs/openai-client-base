...
/// struct for typed errors of method [`assign_project_group_role`]
...
/// struct for typed errors of method [`list_project_group_role_assignments`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`retrieve_project_group_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`unassign_project_group_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn assign_project_group_role(
...
) -> Result<models::GroupRoleAssignment, Error<AssignProjectGroupRoleError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssignProjectGroupRoleError> = serde_json::from_str(&content).ok();
...
pub async fn list_project_group_role_assignments(
    ...
    after: Option<&str>,
    order: Option<&str>,
) -> Result<models::RoleListResource, Error<ListProjectGroupRoleAssignmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_group_id = group_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListProjectGroupRoleAssignmentsError> =
...
pub async fn retrieve_project_group_role(
    ...
    group_id: &str,
    role_id: &str,
) -> Result<models::AssignedRoleDetails, Error<RetrieveProjectGroupRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_group_id = group_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RetrieveProjectGroupRoleError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn unassign_project_group_role(
    ...
    group_id: &str,
    role_id: &str,
) -> Result<models::DeletedRoleAssignmentResource, Error<UnassignProjectGroupRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_group_id = group_id;
    let p_path_role_id = role_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UnassignProjectGroupRoleError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
