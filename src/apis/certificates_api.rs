...
#[bon::builder]
pub async fn activate_organization_certificates(configuration: &configuration::Configuration, toggle_certificates_request: models::ToggleCertificatesRequest) -> Result<models::ListCertificatesResponse, Error<ActivateOrganizationCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_toggle_certificates_request = toggle_certificates_request;

    let uri_str = format!("{}/organization/certificates/activate", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActivateOrganizationCertificatesError> = serde_json::from_str(&content).ok();
...
#[bon::builder]
pub async fn activate_project_certificates(configuration: &configuration::Configuration, project_id: &str, toggle_certificates_request: models::ToggleCertificatesRequest) -> Result<models::ListCertificatesResponse, Error<ActivateProjectCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_body_toggle_certificates_request = toggle_certificates_request;

    let uri_str = format!("{}/organization/projects/{project_id}/certificates/activate", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
#[bon::builder]
pub async fn deactivate_organization_certificates(configuration: &configuration::Configuration, toggle_certificates_request: models::ToggleCertificatesRequest) -> Result<models::ListCertificatesResponse, Error<DeactivateOrganizationCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_toggle_certificates_request = toggle_certificates_request;

    let uri_str = format!("{}/organization/certificates/deactivate", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeactivateOrganizationCertificatesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn deactivate_project_certificates(configuration: &configuration::Configuration, project_id: &str, toggle_certificates_request: models::ToggleCertificatesRequest) -> Result<models::ListCertificatesResponse, Error<DeactivateProjectCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_body_toggle_certificates_request = toggle_certificates_request;

    let uri_str = format!("{}/organization/projects/{project_id}/certificates/deactivate", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeactivateProjectCertificatesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[bon::builder]
pub async fn delete_certificate(configuration: &configuration::Configuration, certificate_id: &str) -> Result<models::DeleteCertificateResponse, Error<DeleteCertificateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_certificate_id = certificate_id;

    let uri_str = format!("{}/organization/certificates/{certificate_id}", configuration.base_path, certificate_id=crate::apis::urlencode(p_path_certificate_id));
...
#[bon::builder]
pub async fn get_certificate(configuration: &configuration::Configuration, certificate_id: &str, include: Option<Vec<String>>) -> Result<models::Certificate, Error<GetCertificateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_certificate_id = certificate_id;
...
#[bon::builder]
pub async fn list_organization_certificates(configuration: &configuration::Configuration, limit: Option<i32>, after: Option<&str>, order: Option<&str>) -> Result<models::ListCertificatesResponse, Error<ListOrganizationCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
#[bon::builder]
pub async fn list_project_certificates(configuration: &configuration::Configuration, project_id: &str, limit: Option<i32>, after: Option<&str>, order: Option<&str>) -> Result<models::ListCertificatesResponse, Error<ListProjectCertificatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_query_limit = limit;
    let p_query_after = after;
    ...
    let uri_str = format!("{}/organization/projects/{project_id}/certificates", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
#[bon::builder]
pub async fn modify_certificate(configuration: &configuration::Configuration, certificate_id: &str, modify_certificate_request: models::ModifyCertificateRequest) -> Result<models::Certificate, Error<ModifyCertificateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_certificate_id = certificate_id;
...
#[bon::builder]
pub async fn upload_certificate(configuration: &configuration::Configuration, upload_certificate_request: models::UploadCertificateRequest) -> Result<models::Certificate, Error<UploadCertificateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
