...
/// struct for typed errors of method [`retrieve_project_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`retrieve_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn retrieve_project_role(
    ...
    project_id: &str,
    role_id: &str,
) -> Result<models::Role, Error<RetrieveProjectRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_role_id = role_id;
...
pub async fn retrieve_role(
    configuration: &configuration::Configuration,
    role_id: &str,
) -> Result<models::Role, Error<RetrieveRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_id = role_id;
