...
#[bon::builder]
pub async fn create_conversation(configuration: &configuration::Configuration, create_conversation_body: Option<models::CreateConversationBody>) -> Result<models::ConversationResource, Error<CreateConversationError>> {
...
#[bon::builder]
pub async fn create_conversation_items(configuration: &configuration::Configuration, conversation_id: &str, create_conversation_items_request: models::CreateConversationItemsRequest, include: Option<Vec<models::Includable>>) -> Result<models::ConversationItemList, Error<CreateConversationItemsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/conversations/{conversation_id}/items", configuration.base_path, conversation_id=crate::apis::urlencode(p_path_conversation_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
#[bon::builder]
pub async fn delete_conversation(configuration: &configuration::Configuration, conversation_id: &str) -> Result<models::DeletedConversationResource, Error<DeleteConversationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;

    let uri_str = format!("{}/conversations/{conversation_id}", configuration.base_path, conversation_id=crate::apis::urlencode(p_path_conversation_id));
...
#[bon::builder]
pub async fn delete_conversation_item(configuration: &configuration::Configuration, conversation_id: &str, item_id: &str) -> Result<models::ConversationResource, Error<DeleteConversationItemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
    let p_path_item_id = item_id;

    let uri_str = format!("{}/conversations/{conversation_id}/items/{item_id}", configuration.base_path, conversation_id=crate::apis::urlencode(p_path_conversation_id), item_id=crate::apis::urlencode(p_path_item_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Get a conversation
#[bon::builder]
pub async fn get_conversation(configuration: &configuration::Configuration, conversation_id: &str) -> Result<models::ConversationResource, Error<GetConversationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
...
#[bon::builder]
pub async fn get_conversation_item(configuration: &configuration::Configuration, conversation_id: &str, item_id: &str, include: Option<Vec<models::Includable>>) -> Result<models::ConversationItem, Error<GetConversationItemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
    let p_path_item_id = item_id;
    let p_query_include = include;
...
#[bon::builder]
pub async fn list_conversation_items(configuration: &configuration::Configuration, conversation_id: &str, limit: Option<i32>, order: Option<&str>, after: Option<&str>, include: Option<Vec<models::Includable>>) -> Result<models::ConversationItemList, Error<ListConversationItemsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
...
#[bon::builder]
pub async fn update_conversation(configuration: &configuration::Configuration, conversation_id: &str, update_conversation_body: Option<models::UpdateConversationBody>) -> Result<models::ConversationResource, Error<UpdateConversationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
