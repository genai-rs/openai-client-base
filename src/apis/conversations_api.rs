...
#[bon::builder]
pub async fn create_conversation(configuration: &configuration::Configuration, create_conversation_request: models::CreateConversationRequest) -> Result<models::ConversationResource, Error<CreateConversationError>> {
...
#[bon::builder]
pub async fn update_conversation(configuration: &configuration::Configuration, conversation_id: &str, update_conversation_body: models::UpdateConversationBody) -> Result<models::ConversationResource, Error<UpdateConversationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_conversation_id = conversation_id;
