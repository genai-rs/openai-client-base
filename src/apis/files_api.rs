...
#[bon::builder]
pub async fn create_file(configuration: &configuration::Configuration, file: std::path::PathBuf, purpose: models::FilePurpose, expires_after: Option<models::FileExpirationAfter>) -> Result<models::OpenAiFile, Error<CreateFileError>> {
