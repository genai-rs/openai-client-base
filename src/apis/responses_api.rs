...
#[bon::builder]
pub async fn cancel_response(configuration: &configuration::Configuration, response_id: &str) -> Result<models::Response, Error<CancelResponseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_response_id = response_id;

    let uri_str = format!("{}/responses/{response_id}/cancel", configuration.base_path, response_id=crate::apis::urlencode(p_path_response_id));
...
#[bon::builder]
pub async fn create_response(configuration: &configuration::Configuration, create_response: models::CreateResponse) -> Result<models::Response, Error<CreateResponseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
#[bon::builder]
pub async fn delete_response(configuration: &configuration::Configuration, response_id: &str) -> Result<(), Error<DeleteResponseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_response_id = response_id;

    let uri_str = format!("{}/responses/{response_id}", configuration.base_path, response_id=crate::apis::urlencode(p_path_response_id));
...
#[bon::builder]
pub async fn get_response(configuration: &configuration::Configuration, response_id: &str, include: Option<Vec<models::Includable>>, stream: Option<bool>, starting_after: Option<i32>, include_obfuscation: Option<bool>) -> Result<models::Response, Error<GetResponseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_response_id = response_id;
...
#[bon::builder]
pub async fn list_input_items(configuration: &configuration::Configuration, response_id: &str, limit: Option<i32>, order: Option<&str>, after: Option<&str>, include: Option<Vec<models::Includable>>) -> Result<models::ResponseItemList, Error<ListInputItemsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_response_id = response_id;
    ...
    let uri_str = format!("{}/responses/{response_id}/input_items", configuration.base_path, response_id=crate::apis::urlencode(p_path_response_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
