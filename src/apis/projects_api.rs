...
/// struct for typed errors of method [`delete_project_model_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`retrieve_project_model_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`update_project_model_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`update_project_service_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn delete_project_api_key(
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        project_id = crate::apis::urlencode(p_path_project_id),
        api_key_id = crate::apis::urlencode(p_path_api_key_id)
    );
    let mut req_builder = configuration
        .client
...
pub async fn delete_project_model_permissions(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<models::ProjectModelPermissionsDeleteResponse, Error<DeleteProjectModelPermissionsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProjectModelPermissionsDeleteResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProjectModelPermissionsDeleteResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_project_api_keys(
    ...
    if let Some(ref param_value) = p_query_owner_project_access {
        req_builder = req_builder.query(&[("owner_project_access", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn retrieve_project_model_permissions(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<models::ProjectModelPermissions, Error<RetrieveProjectModelPermissionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProjectModelPermissions`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProjectModelPermissions`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_project_model_permissions(
    configuration: &configuration::Configuration,
    project_id: &str,
    project_model_permissions_update_request: models::ProjectModelPermissionsUpdateRequest,
) -> Result<models::ProjectModelPermissions, Error<UpdateProjectModelPermissionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_body_project_model_permissions_update_request = project_model_permissions_update_request;
    ...
    req_builder = req_builder.json(&p_body_project_model_permissions_update_request);
...
pub async fn update_project_service_account(
    ...
    project_id: &str,
    service_account_id: &str,
    update_project_service_account_body: models::UpdateProjectServiceAccountBody,
) -> Result<models::ProjectServiceAccount, Error<UpdateProjectServiceAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_service_account_id = service_account_id;
    let p_body_update_project_service_account_body = update_project_service_account_body;
    ...
    req_builder = req_builder.json(&p_body_update_project_service_account_body);
