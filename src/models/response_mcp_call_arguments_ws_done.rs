...
/// ResponseMcpCallArgumentsWsDone : Emitted when the arguments for an MCP tool call are finalized.
...
impl ResponseMcpCallArgumentsWsDone {
...
impl std::fmt::Display for ResponseMcpCallArgumentsWsDone {
