...
impl CreateChatCompletionResponseChoicesInnerLogprobs {
    ...
    pub fn new(content: Vec<models::ChatCompletionTokenLogprob>, refusal: Vec<models::ChatCompletionTokenLogprob>) -> CreateChatCompletionResponseChoicesInnerLogprobs {
