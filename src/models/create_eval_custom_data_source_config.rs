...
pub struct CreateEvalCustomDataSourceConfig {
    ...
    #[serde(rename = "include_sample_schema", skip_serializing_if = "Option::is_none")]
...
impl CreateEvalCustomDataSourceConfig {
    ...
    pub fn new(r#type: Type, item_schema: std::collections::HashMap<String, serde_json::Value>) -> CreateEvalCustomDataSourceConfig {
