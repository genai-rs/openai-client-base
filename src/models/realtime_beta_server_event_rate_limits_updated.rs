...
impl RealtimeBetaServerEventRateLimitsUpdated {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, rate_limits: Vec<models::RealtimeBetaServerEventRateLimitsUpdatedRateLimitsInner>) -> RealtimeBetaServerEventRateLimitsUpdated {
