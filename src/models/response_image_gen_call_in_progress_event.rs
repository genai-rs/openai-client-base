...
impl ResponseImageGenCallInProgressEvent {
    ...
    pub fn new(r#type: Type, output_index: i32, item_id: String, sequence_number: i32) -> ResponseImageGenCallInProgressEvent {
...
impl std::fmt::Display for ResponseImageGenCallInProgressEvent {
