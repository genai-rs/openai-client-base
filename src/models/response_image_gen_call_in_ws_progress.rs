...
/// ResponseImageGenCallInWsProgress : Emitted when an image generation tool call is in progress.
...
impl ResponseImageGenCallInWsProgress {
...
impl std::fmt::Display for ResponseImageGenCallInWsProgress {
