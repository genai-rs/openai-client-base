...
impl RealtimeSessionCreateResponseGa {
    ...
    pub fn new(client_secret: models::RealtimeSessionCreateResponseGaClientSecret, r#type: Type) -> RealtimeSessionCreateResponseGa {
...
impl std::fmt::Display for RealtimeSessionCreateResponseGa {
