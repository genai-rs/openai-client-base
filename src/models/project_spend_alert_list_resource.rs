...
pub struct ProjectSpendAlertListResource {
    ...
    #[serde(rename = "data")]
    pub data: Vec<models::ProjectSpendAlert>,
...
impl ProjectSpendAlertListResource {
    /// Paginated list of project spend alerts.
    pub fn new(
        object: Object,
        data: Vec<models::ProjectSpendAlert>,
...
impl std::fmt::Display for ProjectSpendAlertListResource {
