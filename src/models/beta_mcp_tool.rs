...
pub struct BetaMcpTool {
    ...
    pub allowed_tools: Option<Option<Box<models::BetaMcpToolAllowedTools>>>,
    ...
    pub require_approval: Option<Option<Box<models::BetaMcpToolRequireApproval>>>,
...
impl std::fmt::Display for BetaMcpTool {
