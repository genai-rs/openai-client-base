...
pub struct CreateEvalLabelModelGrader {
    ...
    #[serde(rename = "input")]
    pub input: Vec<models::CreateEvalItem>,
...
impl CreateEvalLabelModelGrader {
    ...
    pub fn new(r#type: Type, name: String, model: String, input: Vec<models::CreateEvalItem>, labels: Vec<String>, passing_labels: Vec<String>) -> CreateEvalLabelModelGrader {
...
impl std::fmt::Display for CreateEvalLabelModelGrader {
