...
impl RealtimeBetaServerEventConversationItemInputAudioTranscriptionSegment {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, item_id: String, content_index: i32, text: String, id: String, speaker: String, start: f32, end: f32) -> RealtimeBetaServerEventConversationItemInputAudioTranscriptionSegment {
...
impl std::fmt::Display for RealtimeBetaServerEventConversationItemInputAudioTranscriptionSegment {
