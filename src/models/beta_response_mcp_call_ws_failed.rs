...
/// BetaResponseMcpCallWsFailed : Emitted when an MCP  tool call has failed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct BetaResponseMcpCallWsFailed {
...
impl BetaResponseMcpCallWsFailed {
...
impl std::fmt::Display for BetaResponseMcpCallWsFailed {
