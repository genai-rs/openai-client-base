...
impl VideoResource {
    ...
    pub fn new(id: String, object: Object, model: models::VideoModel, status: models::VideoStatus, progress: i32, created_at: i32, completed_at: Option<i32>, expires_at: Option<i32>, size: models::VideoSize, seconds: models::VideoSeconds, remixed_from_video_id: Option<String>, error:Option<models::Error2>) -> VideoResource {
        VideoResource {
            id,
            object,
            model,
