...
impl CreateChatCompletionResponseChoicesInner {
    pub fn new(finish_reason: FinishReason, index: i32, message: models::ChatCompletionResponseMessage, logprobs: models::CreateChatCompletionResponseChoicesInnerLogprobs) -> CreateChatCompletionResponseChoicesInner {
