...
/// BetaResponseReasoningSummaryPartDoneEvent : Emitted when a reasoning summary part is completed.
...
impl BetaResponseReasoningSummaryPartDoneEvent {
...
impl std::fmt::Display for BetaResponseReasoningSummaryPartDoneEvent {
