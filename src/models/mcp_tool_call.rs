...
pub struct McpToolCall {
    ...
    #[serde(rename = "approval_request_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub approval_request_id: Option<Option<String>>,
}

impl McpToolCall {
    /// An invocation of a tool on an MCP server. 
    pub fn new(r#type: Type, id: String, server_label: String, name: String, arguments: String) -> McpToolCall {
        McpToolCall {
            r#type,
            id,
            server_label,
