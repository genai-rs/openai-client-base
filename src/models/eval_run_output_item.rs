...
impl EvalRunOutputItem {
    ...
    pub fn new(object: Object, id: String, run_id: String, eval_id: String, created_at: i32, status: String, datasource_item_id: i32, datasource_item: std::collections::HashMap<String, serde_json::Value>, results: Vec<models::EvalRunOutputItemResult>, sample: models::EvalRunOutputItemSample) -> EvalRunOutputItem {
        EvalRunOutputItem {
            object,
            id,
            run_id,
