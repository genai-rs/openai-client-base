...
pub struct BetaModerationResultBody {
    ...
    pub category_applied_input_types:
        std::collections::HashMap<String, Vec<models::BetaModerationInputType>>,
}

impl BetaModerationResultBody {
    ...
    pub fn new(
        ...
        category_applied_input_types: std::collections::HashMap<
            String,
            Vec<models::BetaModerationInputType>,
        >,
...
impl std::fmt::Display for BetaModerationResultBody {
