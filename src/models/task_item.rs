...
impl TaskItem {
    ...
    pub fn new(id: String, object: Object, created_at: i32, thread_id: String, r#type: Type, task_type: models::TaskType, heading: Option<String>, summary: Option<String>) -> TaskItem {
        TaskItem {
            id,
            object,
            created_at,
