...
impl VideoListResource {
    pub fn new(object: Option<serde_json::Value>, data: Vec<models::VideoResource>, first_id: Option<String>, last_id: Option<String>, has_more: bool) -> VideoListResource {
        VideoListResource {
            object,
            data,
            first_id,
...
impl std::fmt::Display for VideoListResource {
