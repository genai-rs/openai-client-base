...
impl EvalRun {
    ...
    pub fn new(object: Object, id: String, eval_id: String, status: String, model: String, name: String, created_at: i32, report_url: String, result_counts: models::EvalRunResultCounts, per_model_usage: Vec<models::EvalRunPerModelUsageInner>, per_testing_criteria_results: Vec<models::EvalRunPerTestingCriteriaResultsInner>, data_source: models::EvalRunDataSource, metadata: std::collections::HashMap<String, String>, error: models::EvalApiError) -> EvalRun {
        EvalRun {
            object,
            id,
            eval_id,
