...
/// ResponseAudioWsDelta : Emitted when there is a partial audio response.
...
impl ResponseAudioWsDelta {
    /// Emitted when there is a partial audio response.
    pub fn new(r#type: Type, sequence_number: i32, delta: String) -> ResponseAudioWsDelta {
...
impl std::fmt::Display for ResponseAudioWsDelta {
