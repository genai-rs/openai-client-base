...
impl VectorStoreSearchResultItem {
    pub fn new(file_id: String, filename: String, score: f64, attributes: Option<std::collections::HashMap<String, models::VectorStoreFileAttributesValue>>, content: Vec<models::VectorStoreSearchResultContentObject>) -> VectorStoreSearchResultItem {
...
impl std::fmt::Display for VectorStoreSearchResultItem {
