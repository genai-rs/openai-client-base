...
impl CreateEvalRequest {
    pub fn new(data_source_config: models::CreateEvalRequestDataSourceConfig, testing_criteria: Vec<models::CreateEvalRequestTestingCriteriaInner>) -> CreateEvalRequest {
        CreateEvalRequest {
            name: None,
            metadata: None,
