...
impl CreateEvalCompletionsRunDataSource {
    ...
    pub fn new(r#type: Type, source: models::CreateEvalCompletionsRunDataSourceSource) -> CreateEvalCompletionsRunDataSource {
...
impl std::fmt::Display for CreateEvalCompletionsRunDataSource {
