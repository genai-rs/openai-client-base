...
pub struct Response {
    ...
    #[serde(rename = "output_text", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "conversation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub conversation: Option<Option<Box<models::Conversation2>>>,
}

impl Response {
    pub fn new(model: String, id: String, object: Object, created_at: f64, error:Option<models::ResponseError>, incomplete_details:Option<models::ResponseAllOfIncompleteDetails>, output: Vec<serde_json::Value>, instructions:Option<models::ResponseAllOfInstructions>, parallel_tool_calls: bool) -> Response {
        Response {
            metadata: None,
            top_logprobs: None,
            temperature: None,
