...
pub struct Response {
    ...
    pub access_programs: Option<Box<models::AccessProgramsBody>>,
    ...
    pub prompt_cache_options: Option<Box<models::PromptCacheOptions>>,
    #[serde(
        rename = "prompt_cache_diagnostics",
        skip_serializing_if = "Option::is_none"
    )]
    pub prompt_cache_diagnostics: Option<Box<models::PromptCacheDiagnostics>>,
    #[serde(
        rename = "moderation",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub conversation: Option<Option<Box<models::ResponseConversation>>>,
...
impl Response {
    pub fn new(
        ...
        id: String,
        object: Object,
        access_programs: Option<models::AccessProgramsBody>,
        created_at: f64,
