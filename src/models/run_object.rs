...
impl RunObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, thread_id: String, assistant_id: String, status: models::RunStatus, required_action: models::RunObjectRequiredAction, last_error: models::RunObjectLastError, expires_at: i32, started_at: i32, cancelled_at: i32, failed_at: i32, completed_at: i32, incomplete_details: models::RunObjectIncompleteDetails, model: String, instructions: String, tools: Vec<models::AssistantTool>, metadata: std::collections::HashMap<String, String>, usage: models::RunCompletionUsage, max_prompt_tokens: i32, max_completion_tokens: i32, truncation_strategy: models::TruncationObject, tool_choice: models::AssistantsApiToolChoiceOption, parallel_tool_calls: bool, response_format: models::AssistantsApiResponseFormatOption) -> RunObject {
        RunObject {
            id,
            object,
            created_at,
