...
/// ResponseReasoningTextWsDelta : Emitted when a delta is added to a reasoning text.
...
impl ResponseReasoningTextWsDelta {
...
impl std::fmt::Display for ResponseReasoningTextWsDelta {
