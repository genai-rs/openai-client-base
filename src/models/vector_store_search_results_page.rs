...
impl VectorStoreSearchResultsPage {
    pub fn new(object: Object, search_query: Vec<String>, data: Vec<models::VectorStoreSearchResultItem>, has_more: bool, next_page: String) -> VectorStoreSearchResultsPage {
