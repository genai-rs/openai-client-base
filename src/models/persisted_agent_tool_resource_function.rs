...
/// PersistedAgentToolResourceFunction : A function defined by the application.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct PersistedAgentToolResourceFunction {
...
impl PersistedAgentToolResourceFunction {
...
impl std::fmt::Display for PersistedAgentToolResourceFunction {
