...
impl RealtimeServerEventConversationCreated {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, conversation: models::RealtimeServerEventConversationCreatedConversation) -> RealtimeServerEventConversationCreated {
