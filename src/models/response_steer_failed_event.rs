...
pub struct ResponseSteerFailedEvent {
    ...
    #[serde(rename = "steer")]
    pub steer: Box<models::ResponseSteerFailedEventSteer>,
    #[serde(rename = "error")]
    pub error: Box<models::ResponseSteerFailedEventError>,
...
impl ResponseSteerFailedEvent {
    ...
    pub fn new(
        r#type: Type,
        sequence_number: i32,
        steer: models::ResponseSteerFailedEventSteer,
        error: models::ResponseSteerFailedEventError,
...
impl std::fmt::Display for ResponseSteerFailedEvent {
