...
/// ResponseWebSearchCallInWsProgress : Emitted when a web search call is initiated.
...
impl ResponseWebSearchCallInWsProgress {
...
impl std::fmt::Display for ResponseWebSearchCallInWsProgress {
