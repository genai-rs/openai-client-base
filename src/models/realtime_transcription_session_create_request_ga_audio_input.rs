...
pub struct RealtimeTranscriptionSessionCreateRequestGaAudioInput {
    ...
    pub turn_detection: Option<Box<models::RealtimeTranscriptionSessionCreateRequestGaAudioInputTurnDetection>>,
}

impl RealtimeTranscriptionSessionCreateRequestGaAudioInput {
    pub fn new() -> RealtimeTranscriptionSessionCreateRequestGaAudioInput {
