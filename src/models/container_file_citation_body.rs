...
impl ContainerFileCitationBody {
    ...
    pub fn new(r#type: Type, container_id: String, file_id: String, start_index: i32, end_index: i32, filename: String) -> ContainerFileCitationBody {
...
impl std::fmt::Display for ContainerFileCitationBody {
