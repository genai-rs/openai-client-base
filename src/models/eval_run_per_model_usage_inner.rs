...
impl EvalRunPerModelUsageInner {
    pub fn new(model_name: String, invocation_count: i32, prompt_tokens: i32, completion_tokens: i32, total_tokens: i32, cached_tokens: i32) -> EvalRunPerModelUsageInner {
