...
pub struct CreateThreadAndRunRequestWithoutStream {
    ...
    pub tool_resources: Option<Box<models::CreateThreadAndRunRequestWithoutStreamToolResources>>,
...
impl CreateThreadAndRunRequestWithoutStream {
    pub fn new(assistant_id: String) -> CreateThreadAndRunRequestWithoutStream {
