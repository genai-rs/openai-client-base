...
/// ResponseReasoningSummaryPartWsDone : Emitted when a reasoning summary part is completed.
...
impl ResponseReasoningSummaryPartWsDone {
...
impl std::fmt::Display for ResponseReasoningSummaryPartWsDone {
