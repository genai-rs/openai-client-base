...
/// ResponseFileSearchCallWsCompleted : Emitted when a file search call is completed (results found).
...
impl ResponseFileSearchCallWsCompleted {
...
impl std::fmt::Display for ResponseFileSearchCallWsCompleted {
