...
pub struct FineTuningJob {
    ...
    pub integrations: Option<Vec<models::FineTuningIntegration>>,
    /// The seed used for the fine-tuning job.
    #[serde(rename = "seed")]
    pub seed: i32,
    /// The Unix timestamp (in seconds) for when the fine-tuning job is estimated to finish. The value will be null if the fine-tuning job is not running.
    #[serde(rename = "estimated_finish", skip_serializing_if = "Option::is_none")]
...
impl FineTuningJob {
    ...
    pub fn new(id: String, created_at: i32, error: models::FineTuningJobError, fine_tuned_model: String, finished_at: i32, hyperparameters: models::FineTuningJobHyperparameters, model: String, object: Object, organization_id: String, result_files: Vec<String>, status: Status, trained_tokens: i32, training_file: String, validation_file: String, seed: i32) -> FineTuningJob {
        FineTuningJob {
            id,
            created_at,
            error: Box::new(error),
