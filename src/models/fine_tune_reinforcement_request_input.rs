...
impl FineTuneReinforcementRequestInput {
    ...
    pub fn new(messages: Vec<models::FineTuneReinforcementRequestInputMessagesInner>) -> FineTuneReinforcementRequestInput {
...
impl std::fmt::Display for FineTuneReinforcementRequestInput {
