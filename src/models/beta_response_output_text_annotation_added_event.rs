...
/// BetaResponseOutputTextAnnotationAddedEvent : Emitted when an annotation is added to output text content.
...
impl std::fmt::Display for BetaResponseOutputTextAnnotationAddedEvent {
