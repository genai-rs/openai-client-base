...
impl ChatSessionResource {
    ...
    pub fn new(id: String, object: Object, expires_at: i32, client_secret: String, workflow: models::ChatkitWorkflow, user: String, rate_limits: models::ChatSessionRateLimits, max_requests_per_1_minute: i32, status: models::ChatSessionStatus, chatkit_configuration: models::ChatSessionChatkitConfiguration) -> ChatSessionResource {
        ChatSessionResource {
            id,
            object,
            expires_at,
