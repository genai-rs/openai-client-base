...
/// ResponseReasoningSummaryTextWsDelta : Emitted when a delta is added to a reasoning summary text.
...
impl ResponseReasoningSummaryTextWsDelta {
...
impl std::fmt::Display for ResponseReasoningSummaryTextWsDelta {
