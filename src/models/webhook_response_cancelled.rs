...
impl WebhookResponseCancelled {
    ...
    pub fn new(created_at: i32, id: String, data: models::WebhookResponseCancelledData, r#type: Type) -> WebhookResponseCancelled {
...
impl std::fmt::Display for WebhookResponseCancelled {
