...
impl ImageGenPartialImageEvent {
    ...
    pub fn new(r#type: Type, b64_json: String, created_at: i32, size: Size, quality: Quality, background: Background, output_format: OutputFormat, partial_image_index: i32) -> ImageGenPartialImageEvent {
