...
/// ResponseMcpListToolsWsFailed : Emitted when the attempt to list available MCP tools has failed.
...
impl ResponseMcpListToolsWsFailed {
...
impl std::fmt::Display for ResponseMcpListToolsWsFailed {
