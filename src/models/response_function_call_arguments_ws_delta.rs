...
/// ResponseFunctionCallArgumentsWsDelta : Emitted when there is a partial function-call arguments delta.
...
impl ResponseFunctionCallArgumentsWsDelta {
...
impl std::fmt::Display for ResponseFunctionCallArgumentsWsDelta {
