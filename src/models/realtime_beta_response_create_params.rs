...
pub struct RealtimeBetaResponseCreateParams {
    ...
    pub tools: Option<Vec<models::RealtimeBetaResponseCreateParamsToolsInner>>,
...
impl RealtimeBetaResponseCreateParams {
    /// Create a new Realtime response with these parameters
    pub fn new() -> RealtimeBetaResponseCreateParams {
...
impl std::fmt::Display for RealtimeBetaResponseCreateParams {
