...
/// ResponseShellCallCommandWsDone : A streaming event that indicated a shell command was completed.
...
impl ResponseShellCallCommandWsDone {
...
impl std::fmt::Display for ResponseShellCallCommandWsDone {
