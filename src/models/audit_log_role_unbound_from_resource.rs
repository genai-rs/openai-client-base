...
/// AuditLogRoleUnboundFromResource : The details for events with this `type`.
...
impl AuditLogRoleUnboundFromResource {
    /// The details for events with this `type`.
    pub fn new() -> AuditLogRoleUnboundFromResource {
...
impl std::fmt::Display for AuditLogRoleUnboundFromResource {
