...
impl ThreadListResource {
    ...
    pub fn new(object: Option<serde_json::Value>, data: Vec<models::ThreadResource>, first_id: Option<String>, last_id: Option<String>, has_more: bool) -> ThreadListResource {
        ThreadListResource {
            object,
            data,
            first_id,
