...
/// ResponseReasoningSummaryTextWsDone : Emitted when a reasoning summary text is completed.
...
impl ResponseReasoningSummaryTextWsDone {
...
impl std::fmt::Display for ResponseReasoningSummaryTextWsDone {
