...
pub struct SessionArtifactListResource {
    /// The object type, which is always `list`.
    #[serde(rename = "object")]
    pub object: Object,
    /// The resources returned in this page, in the requested sort order.
    #[serde(rename = "data")]
    pub data: Vec<models::SessionArtifactResource>,
...
impl SessionArtifactListResource {
    /// A page of Agents API resources, with IDs for retrieving additional pages.
    pub fn new(
        object: Object,
        data: Vec<models::SessionArtifactResource>,
...
impl std::fmt::Display for SessionArtifactListResource {
