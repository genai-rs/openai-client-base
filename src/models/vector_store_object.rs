...
impl VectorStoreObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, name: String, usage_bytes: i32, file_counts: models::VectorStoreObjectFileCounts, status: Status, last_active_at: i32, metadata: std::collections::HashMap<String, String>) -> VectorStoreObject {
        VectorStoreObject {
            id,
            object,
            created_at,
