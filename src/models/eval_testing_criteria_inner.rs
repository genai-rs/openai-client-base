...
impl EvalTestingCriteriaInner {
    pub fn new(r#type: Type, name: String, model: String, input: Vec<models::EvalItem>, labels: Vec<String>, passing_labels: Vec<String>, reference: String, operation: Operation, evaluation_metric: EvaluationMetric, pass_threshold: f64, source: String) -> EvalTestingCriteriaInner {
