...
impl BatchUsage {
    ...
    pub fn new(input_tokens: i32, input_tokens_details: models::BatchUsageInputTokensDetails, output_tokens: i32, output_tokens_details: models::BatchUsageOutputTokensDetails, total_tokens: i32) -> BatchUsage {
        BatchUsage {
            input_tokens,
