...
/// ResponseReasoningSummaryPartWsAdded : Emitted when a new reasoning summary part is added.
...
impl ResponseReasoningSummaryPartWsAdded {
...
impl std::fmt::Display for ResponseReasoningSummaryPartWsAdded {
