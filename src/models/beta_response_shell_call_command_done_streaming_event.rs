...
/// BetaResponseShellCallCommandDoneStreamingEvent : A streaming event that indicated a shell command was completed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct BetaResponseShellCallCommandDoneStreamingEvent {
...
impl BetaResponseShellCallCommandDoneStreamingEvent {
...
impl std::fmt::Display for BetaResponseShellCallCommandDoneStreamingEvent {
