...
/// ResponseWebSearchCallWsCompleted : Emitted when a web search call is completed.
...
impl ResponseWebSearchCallWsCompleted {
...
impl std::fmt::Display for ResponseWebSearchCallWsCompleted {
