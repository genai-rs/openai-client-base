...
/// ResponseCodeInterpreterCallInWsProgress : Emitted when a code interpreter call is in progress.
...
impl ResponseCodeInterpreterCallInWsProgress {
...
impl std::fmt::Display for ResponseCodeInterpreterCallInWsProgress {
