...
/// ResponseAudioTranscriptWsDone : Emitted when the full audio transcript is completed.
...
impl ResponseAudioTranscriptWsDone {
    /// Emitted when the full audio transcript is completed.
    pub fn new(r#type: Type, sequence_number: i32) -> ResponseAudioTranscriptWsDone {
...
impl std::fmt::Display for ResponseAudioTranscriptWsDone {
