...
impl RealtimeServerEventConversationItemInputAudioTranscriptionFailed {
    ...
    pub fn new(event_id: String, r#type: Type, item_id: String, content_index: i32, error: models::RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailedError) -> RealtimeServerEventConversationItemInputAudioTranscriptionFailed {
