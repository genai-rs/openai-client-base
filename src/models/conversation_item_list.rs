...
impl ConversationItemList {
    /// A list of Conversation items.
    pub fn new(object: Option<serde_json::Value>, data: Vec<models::ConversationItem>, has_more: bool, first_id: String, last_id: String) -> ConversationItemList {
...
impl std::fmt::Display for ConversationItemList {
