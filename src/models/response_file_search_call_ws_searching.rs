...
/// ResponseFileSearchCallWsSearching : Emitted when a file search is currently searching.
...
impl ResponseFileSearchCallWsSearching {
...
impl std::fmt::Display for ResponseFileSearchCallWsSearching {
