...
pub struct RealtimeServerEventConversationItemInputAudioTranscriptionCompleted {
    ...
    #[serde(rename = "usage")]
    pub usage: Box<models::RealtimeServerEventConversationItemInputAudioTranscriptionCompletedUsage>,
}
...
impl RealtimeServerEventConversationItemInputAudioTranscriptionCompleted {
    ...
    pub fn new(event_id: String, r#type: Type, item_id: String, content_index: i32, transcript: String, usage: models::RealtimeServerEventConversationItemInputAudioTranscriptionCompletedUsage) -> RealtimeServerEventConversationItemInputAudioTranscriptionCompleted {
