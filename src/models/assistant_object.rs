...
impl AssistantObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, name: String, description: String, model: String, instructions: String, tools: Vec<models::AssistantTool>, metadata: std::collections::HashMap<String, String>) -> AssistantObject {
        AssistantObject {
            id,
            object,
            created_at,
