...
impl AssistantObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, name: Option<String>, description: Option<String>, model: String, instructions: Option<String>, tools: Vec<models::AssistantTool>, metadata: Option<std::collections::HashMap<String, String>>) -> AssistantObject {
        AssistantObject {
            id,
            object,
            created_at,
