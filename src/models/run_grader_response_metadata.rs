...
pub struct RunGraderResponseMetadata {
    ...
    #[serde(rename = "sampled_model_name", deserialize_with = "Option::deserialize")]
    pub sampled_model_name: Option<String>,
}

impl RunGraderResponseMetadata {
    pub fn new(name: String, r#type: String, errors: models::RunGraderResponseMetadataErrors, execution_time: f64, scores: std::collections::HashMap<String, serde_json::Value>, token_usage: Option<i32>, sampled_model_name: Option<String>) -> RunGraderResponseMetadata {
