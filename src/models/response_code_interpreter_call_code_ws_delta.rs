...
/// ResponseCodeInterpreterCallCodeWsDelta : Emitted when a partial code snippet is streamed by the code interpreter.
...
impl ResponseCodeInterpreterCallCodeWsDelta {
...
impl std::fmt::Display for ResponseCodeInterpreterCallCodeWsDelta {
