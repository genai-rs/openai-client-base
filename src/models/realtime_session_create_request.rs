...
pub struct RealtimeSessionCreateRequest {
    ...
    pub input_audio_transcription: Option<Box<models::RealtimeSessionCreateRequestInputAudioTranscription>>,
...
impl RealtimeSessionCreateRequest {
    ...
    pub fn new(client_secret: models::RealtimeSessionCreateRequestClientSecret) -> RealtimeSessionCreateRequest {
