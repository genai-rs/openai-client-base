...
pub struct ChatCompletionMessageListDataInner {
    ...
    #[serde(rename = "content_parts", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub content_parts: Option<Option<Vec<models::ChatCompletionMessageListDataInnerAllOfContentPartsInner>>>,
}

impl ChatCompletionMessageListDataInner {
    pub fn new(content: String, refusal: String, role: Role, id: String) -> ChatCompletionMessageListDataInner {
