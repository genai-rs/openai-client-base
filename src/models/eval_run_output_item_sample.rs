...
impl EvalRunOutputItemSample {
    ...
    pub fn new(input: Vec<models::EvalRunOutputItemSampleInputInner>, output: Vec<models::EvalRunOutputItemSampleOutputInner>, finish_reason: String, model: String, usage: models::EvalRunOutputItemSampleUsage, error: models::EvalApiError, temperature: f64, max_completion_tokens: i32, top_p: f64, seed: i32) -> EvalRunOutputItemSample {
