...
impl WebhookRealtimeCallIncoming {
    ...
    pub fn new(created_at: i32, id: String, data: models::WebhookRealtimeCallIncomingData, r#type: Type) -> WebhookRealtimeCallIncoming {
...
impl std::fmt::Display for WebhookRealtimeCallIncoming {
