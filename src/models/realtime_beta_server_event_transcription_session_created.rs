...
impl RealtimeBetaServerEventTranscriptionSessionCreated {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, session: models::RealtimeTranscriptionSessionCreateResponse) -> RealtimeBetaServerEventTranscriptionSessionCreated {
