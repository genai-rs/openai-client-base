...
/// BetaResponseErrorCode : The error code for the response.
...
impl std::fmt::Display for BetaResponseErrorCode {
...
impl Default for BetaResponseErrorCode {
    fn default() -> BetaResponseErrorCode {
        Self::ServerError
    }
}
