...
pub struct BetaTokenCountsBody {
    ...
    pub tools: Option<Option<Vec<models::BetaTool>>>,
    #[serde(
        rename = "text",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub text: Option<Option<Box<models::BetaResponseTextParam>>>,
    #[serde(
        rename = "reasoning",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub truncation: Option<models::BetaTruncationEnum>,
    ...
    pub personality: Option<Box<models::BetaPersonalityEnum>>,
    #[serde(
        rename = "conversation",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub tool_choice: Option<Option<Box<models::BetaToolChoiceParam>>>,
...
impl BetaTokenCountsBody {
    pub fn new() -> BetaTokenCountsBody {
        BetaTokenCountsBody {
            model: None,
            input: None,
...
impl std::fmt::Display for BetaTokenCountsBody {
