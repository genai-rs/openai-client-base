...
/// SessionEventAgentSessionTurnOutputTextDelta : Emitted when text is appended to an output text content part.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct SessionEventAgentSessionTurnOutputTextDelta {
...
impl SessionEventAgentSessionTurnOutputTextDelta {
...
impl Default for Type {
    fn default() -> Type {
        Self::AgentSessionTurnOutputTextDelta
    }
}

impl std::fmt::Display for SessionEventAgentSessionTurnOutputTextDelta {
