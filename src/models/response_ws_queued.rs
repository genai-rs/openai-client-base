...
/// ResponseWsQueued : Emitted when a response is queued and waiting to be processed.
...
impl ResponseWsQueued {
    /// Emitted when a response is queued and waiting to be processed.
    pub fn new(r#type: Type, response: models::Response, sequence_number: i32) -> ResponseWsQueued {
        ResponseWsQueued {
            r#type,
...
impl std::fmt::Display for ResponseWsQueued {
