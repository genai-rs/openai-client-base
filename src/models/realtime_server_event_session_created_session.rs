...
/// RealtimeServerEventSessionCreatedSession : The session configuration.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct RealtimeServerEventSessionCreatedSession {
...
impl RealtimeServerEventSessionCreatedSession {
    /// The session configuration.
    pub fn new(r#type: Type) -> RealtimeServerEventSessionCreatedSession {
