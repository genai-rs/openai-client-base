...
pub struct AuditLog {
    ...
    #[serde(rename = "checkpoint.permission.created", skip_serializing_if = "Option::is_none")]
    pub checkpoint_permission_created: Option<Box<models::AuditLogCheckpointPermissionCreated>>,
    #[serde(rename = "checkpoint.permission.deleted", skip_serializing_if = "Option::is_none")]
    pub checkpoint_permission_deleted: Option<Box<models::AuditLogCheckpointPermissionDeleted>>,
    #[serde(rename = "external_key.registered", skip_serializing_if = "Option::is_none")]
    pub external_key_registered: Option<Box<models::AuditLogExternalKeyRegistered>>,
    #[serde(rename = "external_key.removed", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ip_allowlist.created", skip_serializing_if = "Option::is_none")]
    pub ip_allowlist_created: Option<Box<models::AuditLogIpAllowlistCreated>>,
    #[serde(rename = "ip_allowlist.updated", skip_serializing_if = "Option::is_none")]
    pub ip_allowlist_updated: Option<Box<models::AuditLogIpAllowlistUpdated>>,
    #[serde(rename = "ip_allowlist.deleted", skip_serializing_if = "Option::is_none")]
    pub ip_allowlist_deleted: Option<Box<models::AuditLogIpAllowlistDeleted>>,
    #[serde(rename = "ip_allowlist.config.activated", skip_serializing_if = "Option::is_none")]
    pub ip_allowlist_config_activated: Option<Box<models::AuditLogIpAllowlistConfigActivated>>,
    #[serde(rename = "ip_allowlist.config.deactivated", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "role.assignment.created", skip_serializing_if = "Option::is_none")]
    pub role_assignment_created: Option<Box<models::AuditLogRoleAssignmentCreated>>,
    #[serde(rename = "role.assignment.deleted", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "certificate.created", skip_serializing_if = "Option::is_none")]
    pub certificate_created: Option<Box<models::AuditLogCertificateCreated>>,
    #[serde(rename = "certificate.updated", skip_serializing_if = "Option::is_none")]
    pub certificate_updated: Option<Box<models::AuditLogCertificateCreated>>,
    #[serde(rename = "certificate.deleted", skip_serializing_if = "Option::is_none")]
    pub certificate_deleted: Option<Box<models::AuditLogCertificateDeleted>>,
    #[serde(rename = "certificates.activated", skip_serializing_if = "Option::is_none")]
    pub certificates_activated: Option<Box<models::AuditLogCertificatesActivated>>,
    #[serde(rename = "certificates.deactivated", skip_serializing_if = "Option::is_none")]
