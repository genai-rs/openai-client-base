...
pub struct AuditLog {
    ...
    #[serde(rename = "checkpoint_permission.created", skip_serializing_if = "Option::is_none")]
    pub checkpoint_permission_created: Option<Box<models::AuditLogCheckpointPermissionCreated>>,
    #[serde(rename = "checkpoint_permission.deleted", skip_serializing_if = "Option::is_none")]
