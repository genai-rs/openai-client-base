...
impl RealtimeServerEventResponseFunctionCallArgumentsDone {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, response_id: String, item_id: String, output_index: i32, call_id: String, arguments: String) -> RealtimeServerEventResponseFunctionCallArgumentsDone {
