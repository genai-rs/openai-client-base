...
pub struct ComputerToolCallOutputResource {
    ...
    #[serde(rename = "acknowledged_safety_checks", skip_serializing_if = "Option::is_none")]
...
impl ComputerToolCallOutputResource {
    pub fn new(r#type: Type, id: String, call_id: String, output: models::ComputerScreenshotImage) -> ComputerToolCallOutputResource {
...
impl std::fmt::Display for ComputerToolCallOutputResource {
