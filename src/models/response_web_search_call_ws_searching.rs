...
/// ResponseWebSearchCallWsSearching : Emitted when a web search call is executing.
...
impl ResponseWebSearchCallWsSearching {
...
impl std::fmt::Display for ResponseWebSearchCallWsSearching {
