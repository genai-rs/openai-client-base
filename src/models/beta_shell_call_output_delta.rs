...
/// BetaShellCallOutputDelta : A delta of stdout/stderr emitted while a shell call was running.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct BetaShellCallOutputDelta {
...
impl BetaShellCallOutputDelta {
    /// A delta of stdout/stderr emitted while a shell call was running.
    pub fn new() -> BetaShellCallOutputDelta {
...
impl std::fmt::Display for BetaShellCallOutputDelta {
