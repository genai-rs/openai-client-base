...
pub struct ComputerCallOutputItemParam {
    ...
    #[serde(rename = "acknowledged_safety_checks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ComputerCallOutputItemParam {
    ...
    pub fn new(call_id: String, r#type: Type, output: models::ComputerScreenshotImage) -> ComputerCallOutputItemParam {
