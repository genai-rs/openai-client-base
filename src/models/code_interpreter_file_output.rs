...
impl CodeInterpreterFileOutput {
    ...
    pub fn new(r#type: Type, files: Vec<models::CodeInterpreterFileOutputFilesInner>) -> CodeInterpreterFileOutput {
...
impl std::fmt::Display for CodeInterpreterFileOutput {
