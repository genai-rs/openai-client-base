...
impl ThreadObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, tool_resources:Option<models::ModifyThreadRequestToolResources>, metadata: Option<std::collections::HashMap<String, String>>) -> ThreadObject {
        ThreadObject {
            id,
            object,
            created_at,
