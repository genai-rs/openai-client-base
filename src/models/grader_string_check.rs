...
impl GraderStringCheck {
    /// A StringCheckGrader object that performs a string comparison between input and reference using a specified operation. 
    pub fn new(r#type: Type, name: String, input: String, reference: String, operation: Operation) -> GraderStringCheck {
        GraderStringCheck {
            r#type,
            name,
            input,
...
impl std::fmt::Display for GraderStringCheck {
