...
impl ThreadItemListResource {
    ...
    pub fn new(object: Option<serde_json::Value>, data: Vec<models::ThreadItem>, first_id: Option<String>, last_id: Option<String>, has_more: bool) -> ThreadItemListResource {
