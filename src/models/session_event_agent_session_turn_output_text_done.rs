...
/// SessionEventAgentSessionTurnOutputTextDone : Emitted when an output text content part is complete.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct SessionEventAgentSessionTurnOutputTextDone {
...
impl SessionEventAgentSessionTurnOutputTextDone {
...
impl Default for Type {
    fn default() -> Type {
        Self::AgentSessionTurnOutputTextDone
    }
}

impl std::fmt::Display for SessionEventAgentSessionTurnOutputTextDone {
