...
impl ResponseUsage {
    ...
    pub fn new(input_tokens: i32, input_tokens_details: models::ResponseUsageInputTokensDetails, output_tokens: i32, output_tokens_details: models::BatchUsageOutputTokensDetails, total_tokens: i32) -> ResponseUsage {
        ResponseUsage {
            input_tokens,
