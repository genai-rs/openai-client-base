...
/// ResponseShellCallCommandWsDelta : A streaming event that indicated a shell command was incrementally updated.
...
impl ResponseShellCallCommandWsDelta {
...
impl std::fmt::Display for ResponseShellCallCommandWsDelta {
