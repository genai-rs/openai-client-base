...
/// ResponseShellCallCommandWsAdded : A streaming event that indicated a shell command was added to a tool call.
...
impl ResponseShellCallCommandWsAdded {
...
impl std::fmt::Display for ResponseShellCallCommandWsAdded {
