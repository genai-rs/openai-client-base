...
impl VectorStoreFileObject {
    ...
    pub fn new(id: String, object: Object, usage_bytes: i32, created_at: i32, vector_store_id: String, status: Status, last_error: models::VectorStoreFileObjectLastError) -> VectorStoreFileObject {
