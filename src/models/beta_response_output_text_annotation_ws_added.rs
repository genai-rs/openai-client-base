...
/// BetaResponseOutputTextAnnotationWsAdded : Emitted when an annotation is added to output text content.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct BetaResponseOutputTextAnnotationWsAdded {
    ...
    pub annotation: Box<models::BetaAnnotation>,
...
impl BetaResponseOutputTextAnnotationWsAdded {
    ...
    pub fn new(
        ...
        sequence_number: i32,
        annotation: models::BetaAnnotation,
...
impl std::fmt::Display for BetaResponseOutputTextAnnotationWsAdded {
