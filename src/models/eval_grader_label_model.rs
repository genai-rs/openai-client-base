...
impl EvalGraderLabelModel {
    pub fn new(r#type: Type, name: String, model: String, input: Vec<models::EvalItem>, labels: Vec<String>, passing_labels: Vec<String>) -> EvalGraderLabelModel {
...
impl std::fmt::Display for EvalGraderLabelModel {
