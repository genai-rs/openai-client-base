...
pub struct SessionItemListResource {
    /// The object type, which is always `list`.
    #[serde(rename = "object")]
    pub object: Object,
    /// The resources returned in this page, in the requested sort order.
    #[serde(rename = "data")]
    pub data: Vec<models::SessionTurnItemResource>,
...
impl std::fmt::Display for SessionItemListResource {
