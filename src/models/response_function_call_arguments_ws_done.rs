...
/// ResponseFunctionCallArgumentsWsDone : Emitted when function-call arguments are finalized.
...
impl ResponseFunctionCallArgumentsWsDone {
...
impl std::fmt::Display for ResponseFunctionCallArgumentsWsDone {
