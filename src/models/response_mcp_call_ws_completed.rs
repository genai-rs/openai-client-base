...
/// ResponseMcpCallWsCompleted : Emitted when an MCP  tool call has completed successfully.
...
impl ResponseMcpCallWsCompleted {
...
impl std::fmt::Display for ResponseMcpCallWsCompleted {
