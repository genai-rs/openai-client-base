...
/// BetaResponseUsage : Represents token usage details including input tokens, output tokens, a breakdown of output tokens, and the total tokens used.
...
impl std::fmt::Display for BetaResponseUsage {
