...
/// VaultCredentialNetworkingResourceLimited : Allows substitution only for the listed hosts. The environment network policy must also allow these hosts.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct VaultCredentialNetworkingResourceLimited {
...
impl VaultCredentialNetworkingResourceLimited {
...
impl std::fmt::Display for VaultCredentialNetworkingResourceLimited {
