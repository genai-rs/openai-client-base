...
impl RealtimeServerEventResponseOutputItemDone {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, response_id: String, output_index: i32, item: models::RealtimeConversationItem) -> RealtimeServerEventResponseOutputItemDone {
