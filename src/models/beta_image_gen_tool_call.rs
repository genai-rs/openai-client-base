...
pub struct BetaImageGenToolCall {
    ...
    pub action: Option<Option<models::BetaImageGenActionEnum>>,
    #[serde(
        rename = "background",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub background: Option<Option<models::BetaImageBackground>>,
    #[serde(
    ...
    pub output_format: Option<Option<models::BetaImageOutputFormat>>,
...
impl std::fmt::Display for BetaImageGenToolCall {
