...
pub struct RealtimeSessionCreateResponseAudioInput {
    ...
    pub turn_detection: Option<Box<models::RealtimeSessionCreateResponseAudioInputTurnDetection>>,
}

impl RealtimeSessionCreateResponseAudioInput {
    pub fn new() -> RealtimeSessionCreateResponseAudioInput {
...
impl std::fmt::Display for RealtimeSessionCreateResponseAudioInput {
