...
impl GraderMultiGraders {
    pub fn new(r#type: Type, name: String, input: Vec<models::EvalItem>, reference: String, operation: Operation, evaluation_metric: EvaluationMetric, source: String, model: String, labels: Vec<String>, passing_labels: Vec<String>) -> GraderMultiGraders {
        GraderMultiGraders {
            r#type,
            name,
            input,
