...
impl MessageStreamEventAnyOf4 {
    /// Occurs when a [message](https://platform.openai.com/docs/api-reference/messages/object) ends before it is completed.
    pub fn new(event: Event, data: models::MessageObject) -> MessageStreamEventAnyOf4 {
...
impl std::fmt::Display for MessageStreamEventAnyOf4 {
