...
/// BetaResponseReasoningSummaryPartAddedEvent : Emitted when a new reasoning summary part is added.
...
impl BetaResponseReasoningSummaryPartAddedEvent {
...
impl std::fmt::Display for BetaResponseReasoningSummaryPartAddedEvent {
