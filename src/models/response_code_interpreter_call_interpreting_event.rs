...
impl ResponseCodeInterpreterCallInterpretingEvent {
    ...
    pub fn new(r#type: Type, output_index: i32, item_id: String, sequence_number: i32) -> ResponseCodeInterpreterCallInterpretingEvent {
...
impl std::fmt::Display for ResponseCodeInterpreterCallInterpretingEvent {
