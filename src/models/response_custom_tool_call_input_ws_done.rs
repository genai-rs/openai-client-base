...
/// ResponseCustomToolCallInputWsDone : Event indicating that input for a custom tool call is complete.
...
impl ResponseCustomToolCallInputWsDone {
...
impl std::fmt::Display for ResponseCustomToolCallInputWsDone {
