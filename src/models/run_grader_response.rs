...
impl RunGraderResponse {
    pub fn new(reward: f64, metadata: models::RunGraderResponseMetadata, sub_rewards: std::collections::HashMap<String, serde_json::Value>, model_grader_token_usage_per_model: std::collections::HashMap<String, serde_json::Value>) -> RunGraderResponse {
        RunGraderResponse {
            reward,
