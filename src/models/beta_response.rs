...
pub struct BetaResponse {
    ...
    pub error: Option<Box<models::BetaResponseError>>,
    #[serde(
        rename = "incomplete_details",
        deserialize_with = "Option::deserialize"
    )]
    pub incomplete_details: Option<Box<models::Object018>>,
    ...
    #[serde(rename = "output")]
    pub output: Vec<models::BetaOutputItem>,
    #[serde(
        rename = "reasoning",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub instructions: Option<Box<models::BetaResponseAllOfInstructions>>,
    ...
    pub usage: Option<Box<models::BetaResponseUsage>>,
    #[serde(
    ...
    pub moderation: Option<Option<Box<models::BetaModeration>>>,
    ...
    pub conversation: Option<Option<Box<models::BetaConversation2>>>,
...
impl BetaResponse {
    pub fn new(
        ...
        output: Vec<models::BetaOutputItem>,
        instructions: Option<models::BetaResponseAllOfInstructions>,
...
impl std::fmt::Display for BetaResponse {
