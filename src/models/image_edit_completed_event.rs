...
impl ImageEditCompletedEvent {
    ...
    pub fn new(r#type: Type, b64_json: String, created_at: i32, size: Size, quality: Quality, background: Background, output_format: OutputFormat, usage: models::ImagesUsage) -> ImageEditCompletedEvent {
...
impl std::fmt::Display for ImageEditCompletedEvent {
