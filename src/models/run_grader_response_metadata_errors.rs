...
pub struct RunGraderResponseMetadataErrors {
    ...
    #[serde(rename = "python_grader_server_error_type", deserialize_with = "Option::deserialize")]
    ...
    #[serde(rename = "python_grader_runtime_error_details", deserialize_with = "Option::deserialize")]
    ...
    #[serde(rename = "model_grader_server_error_details", deserialize_with = "Option::deserialize")]
    pub model_grader_server_error_details: Option<String>,
}

impl RunGraderResponseMetadataErrors {
    pub fn new(formula_parse_error: bool, sample_parse_error: bool, truncated_observation_error: bool, unresponsive_reward_error: bool, invalid_variable_error: bool, other_error: bool, python_grader_server_error: bool, python_grader_server_error_type: Option<String>, python_grader_runtime_error: bool, python_grader_runtime_error_details: Option<String>, model_grader_server_error: bool, model_grader_refusal_error: bool, model_grader_parse_error: bool, model_grader_server_error_details: Option<String>) -> RunGraderResponseMetadataErrors {
