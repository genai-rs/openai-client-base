...
impl RealtimeServerEventResponseAudioTranscriptDone {
    ...
    pub fn new(event_id: String, r#type: Option<serde_json::Value>, response_id: String, item_id: String, output_index: i32, content_index: i32, transcript: String) -> RealtimeServerEventResponseAudioTranscriptDone {
