...
pub struct ListFineTuningCheckpointPermissionResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::FineTuningCheckpointPermission>,
    #[serde(rename = "object")]
    pub object: Object,
...
impl ListFineTuningCheckpointPermissionResponse {
    pub fn new(data: Vec<models::FineTuningCheckpointPermission>, object: Object, has_more: bool) -> ListFineTuningCheckpointPermissionResponse {
...
impl std::fmt::Display for ListFineTuningCheckpointPermissionResponse {
