...
impl Eval {
    ...
    pub fn new(object: Object, id: String, name: String, data_source_config: models::EvalDataSourceConfig, testing_criteria: Vec<models::EvalTestingCriteriaInner>, created_at: i32, metadata: Option<std::collections::HashMap<String, String>>) -> Eval {
        Eval {
            object,
            id,
            name,
