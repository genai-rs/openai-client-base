...
impl RunStepObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, assistant_id: String, thread_id: String, run_id: String, r#type: Type, status: Status, step_details: models::RunStepObjectStepDetails, last_error: models::RunStepObjectLastError, expired_at: i32, cancelled_at: i32, failed_at: i32, completed_at: i32, metadata: std::collections::HashMap<String, String>, usage: models::RunStepCompletionUsage) -> RunStepObject {
        RunStepObject {
            id,
            object,
            created_at,
