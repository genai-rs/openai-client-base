...
impl RunStepObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, assistant_id: String, thread_id: String, run_id: String, r#type: Type, status: Status, step_details: models::RunStepObjectStepDetails, last_error:Option<models::RunStepObjectLastError>, expired_at: Option<i32>, cancelled_at: Option<i32>, failed_at: Option<i32>, completed_at: Option<i32>, metadata: Option<std::collections::HashMap<String, String>>, usage:Option<models::RunStepCompletionUsage>) -> RunStepObject {
        RunStepObject {
            id,
            object,
            created_at,
