...
pub struct ChatkitWorkflow {
    ...
    pub state_variables: Option<std::collections::HashMap<String, models::Object025Value>>,
...
impl ChatkitWorkflow {
    ...
    pub fn new(
        ...
        state_variables: Option<std::collections::HashMap<String, models::Object025Value>>,
