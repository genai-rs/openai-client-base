...
pub struct BetaCreateResponse {
    ...
    pub reasoning: Option<Option<Box<models::BetaReasoning>>>,
    ...
    pub include: Option<Option<Vec<models::BetaIncludeEnum>>>,
    ...
    pub moderation: Option<Option<Box<models::BetaModerationParam>>>,
    ...
    pub conversation: Option<Option<Box<models::BetaConversationParam>>>,
    ...
    pub context_management: Option<Option<Vec<models::BetaContextManagementParam>>>,
    ...
    pub multi_agent: Option<Option<Box<models::BetaMultiAgentParam>>>,
}

impl BetaCreateResponse {
    pub fn new() -> BetaCreateResponse {
        BetaCreateResponse {
            metadata: None,
            top_logprobs: None,
            temperature: None,
...
impl std::fmt::Display for BetaCreateResponse {
