...
impl CreateEvalResponsesRunDataSource {
    ...
    pub fn new(r#type: Type, source: models::CreateEvalResponsesRunDataSourceSource) -> CreateEvalResponsesRunDataSource {
...
impl std::fmt::Display for CreateEvalResponsesRunDataSource {
