...
impl MessageObject {
    ...
    pub fn new(id: String, object: Object, created_at: i32, thread_id: String, status: Status, incomplete_details: models::MessageObjectIncompleteDetails, completed_at: i32, incomplete_at: i32, role: Role, content: Vec<models::MessageContent>, assistant_id: String, run_id: String, attachments: Vec<models::MessageObjectAttachmentsInner>, metadata: std::collections::HashMap<String, String>) -> MessageObject {
        MessageObject {
            id,
            object,
            created_at,
