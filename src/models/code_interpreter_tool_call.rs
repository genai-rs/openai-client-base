...
impl CodeInterpreterToolCall {
    ...
    pub fn new(r#type: Type, id: String, status: Status, container_id: String, code: Option<String>, outputs: Option<Vec<models::CodeInterpreterToolCallOutputsInner>>) -> CodeInterpreterToolCall {
