...
------------ | ------------- | ------------- | -------------
**object** | **String** |  | 
**num_requests** | **i32** | The count of file search calls. | 
...
**vector_store_id** | Option<**String**> | When `group_by=vector_store_id`, this field provides the vector store ID of the grouped usage result. | [optional]
