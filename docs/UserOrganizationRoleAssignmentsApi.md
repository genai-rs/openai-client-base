...
[**retrieve_user_role**](UserOrganizationRoleAssignmentsApi.md#retrieve_user_role) | **GET** /organization/users/{user_id}/roles/{role_id} | Retrieve user organization role
