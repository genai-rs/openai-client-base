...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | The item type. Always `resume_subagent_call`. | 
...
**sender_agent_id** | **String** | The ID of the agent requesting the resume. | 
**recipient_agent_id** | **String** | The ID of the agent to resume. | 
