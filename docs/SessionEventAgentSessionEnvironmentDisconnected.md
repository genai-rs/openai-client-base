...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | The type of the object. Always `agent.session.environment.disconnected`. | 
...
**environment** | [**models::SessionEnvironmentStateResource**](SessionEnvironmentStateResource.md) |  | 
