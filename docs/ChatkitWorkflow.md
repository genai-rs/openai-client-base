...
**state_variables** | Option<[**std::collections::HashMap<String, models::Object021Value>**](Object0_21_value.md)> | State variable key-value pairs applied when invoking the workflow. Defaults to null when no overrides were provided. | 
