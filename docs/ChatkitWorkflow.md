...
**state_variables** | Option<[**std::collections::HashMap<String, models::Object025Value>**](Object0_25_value.md)> | State variable key-value pairs applied when invoking the workflow. Defaults to null when no overrides were provided. | 
