...
**outputs** | Option<[**Vec<models::BetaCodeInterpreterToolCallOutputsInner>**](BetaCodeInterpreterToolCall_outputs_inner.md)> | The outputs generated by the code interpreter, such as logs or images. Can be null if no outputs are available.  | 
