...
**prompt_cache_breakpoint** | Option<[**models::BetaPromptCacheBreakpointConfig**](BetaPromptCacheBreakpointConfig.md)> |  | [optional]
**file_url** | Option<**String**> | The URL of the file to be sent to the model. | [optional]
**detail** | Option<[**models::BetaFileInputDetail**](BetaFileInputDetail.md)> |  | [optional]
