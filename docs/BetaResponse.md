...
**top_logprobs** | Option<**i32**> | An integer between 0 and 20 specifying the maximum number of most likely tokens to return at each token position, each with an associated log probability. In some cases, the number of returned tokens may be fewer than requested.  | [optional]
...
**prompt_cache_key** | Option<**String**> | Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the `user` field. [Learn more](https://developers.openai.com/api/docs/guides/prompt-caching).  | [optional]
**prompt_cache_retention** | Option<**String**> | Deprecated. Use `prompt_cache_options.ttl` instead.  The retention policy for the prompt cache. Set to `24h` to enable extended prompt caching, which keeps cached prefixes active for longer, up to a maximum of 24 hours. [Learn more](https://developers.openai.com/api/docs/guides/prompt-caching#prompt-cache-retention). This field expresses a maximum retention policy, while `prompt_cache_options.ttl` expresses a minimum cache lifetime. The two fields are independent and do not interact. For `gpt-5.5`, `gpt-5.5-pro`, and future models, only `24h` is supported.  For older models that support both `in_memory` and `24h`, the default depends on your organization's data retention policy:   - Organizations without ZDR enabled default to `24h`.   - Organizations with ZDR enabled default to `in_memory` when `prompt_cache_retention` is not specified.  | [optional]
...
**service_tier** | Option<[**models::BetaServiceTierResponses**](BetaServiceTierResponses.md)> |  | [optional]
...
**access_programs** | Option<[**models::BetaAccessProgramsBody**](BetaAccessProgramsBody.md)> |  | 
...
**error** | Option<[**models::BetaResponseError**](BetaResponseError.md)> |  | 
**incomplete_details** | Option<[**models::Object018**](Object0_18.md)> |  | 
**output** | [**Vec<models::BetaOutputItem>**](BetaOutputItem.md) | An array of content items generated by the model.  - The length and order of items in the `output` array is dependent   on the model's response. - Rather than accessing the first item in the `output` array and   assuming it's an `assistant` message with the content generated by   the model, you might consider using the `output_text` property where   supported in SDKs.  | 
**reasoning** | Option<[**models::BetaReasoning**](BetaReasoning.md)> |  | [optional]
**instructions** | Option<[**models::BetaResponseAllOfInstructions**](BetaResponse_allOf_instructions.md)> |  | 
...
**usage** | Option<[**models::BetaResponseUsage**](BetaResponseUsage.md)> |  | [optional]
**prompt_cache_options** | Option<[**models::BetaPromptCacheOptions**](BetaPromptCacheOptions.md)> |  | [optional]
**prompt_cache_diagnostics** | Option<[**models::BetaPromptCacheDiagnostics**](BetaPromptCacheDiagnostics.md)> |  | [optional]
**moderation** | Option<[**models::BetaModeration**](BetaModeration.md)> |  | [optional]
**parallel_tool_calls** | **bool** | Whether to allow the model to run tool calls in parallel.  | 
**conversation** | Option<[**models::BetaResponseConversation**](BetaResponseConversation.md)> |  | [optional]
**max_output_tokens** | Option<**i32**> | An upper bound for the number of tokens that can be generated for a response, including visible output tokens and [reasoning tokens](https://developers.openai.com/api/docs/guides/reasoning).  | [optional]
