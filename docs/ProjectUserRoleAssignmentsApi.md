...
[**retrieve_project_user_role**](ProjectUserRoleAssignmentsApi.md#retrieve_project_user_role) | **GET** /projects/{project_id}/users/{user_id}/roles/{role_id} | Retrieve project user role
