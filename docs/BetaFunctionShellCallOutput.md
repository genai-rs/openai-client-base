...
**status** | [**models::BetaFunctionShellCallOutputStatusEnum**](BetaFunctionShellCallOutputStatusEnum.md) |  | 
**output** | [**Vec<models::BetaFunctionShellCallOutputContent>**](BetaFunctionShellCallOutputContent.md) | An array of shell call output contents | 
