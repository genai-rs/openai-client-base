...
**created_at** | **i32** | Unix timestamp (in seconds) of when this Response was created.  | 
**completed_at** | Option<**i32**> | Unix timestamp (in seconds) of when this Response was completed. Only present when the status is `completed`.  | [optional]
**error** | Option<[**models::ResponseError**](ResponseError.md)> |  | 
**incomplete_details** | Option<[**models::Object013**](Object0_13.md)> |  | 
