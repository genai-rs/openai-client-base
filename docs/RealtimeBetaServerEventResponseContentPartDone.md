...
**r#type** | **String** | The event type, must be `response.content_part.done`. | 
...
**part** | [**models::RealtimeBetaServerEventResponseContentPartDonePart**](RealtimeBetaServerEventResponseContentPartDone_part.md) |  | 
