...
**call_id** | Option<**String**> | The unique ID of the function tool call generated by the model. | [optional]
...
**name** | Option<**String**> | The name of the tool that produced the output. | [optional]
**namespace** | Option<**String**> | The namespace of the tool that produced the output. | [optional]
