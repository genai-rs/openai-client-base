...
**workload_identity_provider_created** | Option<[**models::AuditLogWorkloadIdentityProviderCreated**](AuditLog_workload_identity_provider_created.md)> |  | [optional]
**workload_identity_provider_updated** | Option<[**models::AuditLogWorkloadIdentityProviderUpdated**](AuditLog_workload_identity_provider_updated.md)> |  | [optional]
**workload_identity_provider_deleted** | Option<[**models::AuditLogWorkloadIdentityProviderDeleted**](AuditLog_workload_identity_provider_deleted.md)> |  | [optional]
**workload_identity_provider_mapping_created** | Option<[**models::AuditLogWorkloadIdentityProviderMappingCreated**](AuditLog_workload_identity_provider_mapping_created.md)> |  | [optional]
**workload_identity_provider_mapping_updated** | Option<[**models::AuditLogWorkloadIdentityProviderMappingUpdated**](AuditLog_workload_identity_provider_mapping_updated.md)> |  | [optional]
**workload_identity_provider_mapping_deleted** | Option<[**models::AuditLogWorkloadIdentityProviderMappingDeleted**](AuditLog_workload_identity_provider_mapping_deleted.md)> |  | [optional]
