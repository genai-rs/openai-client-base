...
**size** | Option<[**models::ImagesResponseSize**](ImagesResponse_size.md)> |  | [optional]
**quality** | Option<**String**> | The quality of the image generated. One of `low`, `medium`, `high`, `xhigh`, or `max`. | [optional]
