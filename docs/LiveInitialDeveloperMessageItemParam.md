...
**role** | **String** | The author of this history message. Always `developer`. | 
**content** | [**Vec<models::LiveInitialInputTextContentPartParam>**](LiveInitialInputTextContentPartParam.md) | The message content. Supply exactly one text part for the initial Live conversation history. | 
