...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | The type of the object. Always `agent.session.turn.reasoning_summary_text.delta`. | 
...
**summary_index** | **i64** | The index of the summary content part. | 
**delta** | **String** | The summary text that was appended. | 
