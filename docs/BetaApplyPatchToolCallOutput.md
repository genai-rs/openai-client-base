...
**status** | [**models::BetaApplyPatchCallOutputStatus**](BetaApplyPatchCallOutputStatus.md) |  | 
**output** | Option<**String**> | Optional textual output returned by the apply patch tool. | [optional]
