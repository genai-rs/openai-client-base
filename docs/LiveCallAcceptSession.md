...
**audio** | Option<[**models::LiveMediaSessionAudioParam**](LiveMediaSessionAudioParam.md)> |  | [optional]
**delegation** | Option<[**models::Delegation**](delegation.md)> |  | [optional]
...
**r#type** | **String** | The session type. Always `live`. | 
