...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | The item type. Always `close_subagent_call`. | 
...
**sender_agent_id** | **String** | The ID of the agent requesting the close. | 
**recipient_agent_id** | **String** | The ID of the agent to close. | 
