...
------------ | ------------- | ------------- | -------------
**r#type** | **String** | The item type. Always `wait_for_subagents_call`. | 
...
**sender_agent_id** | **String** | The ID of the agent waiting for results. | 
**recipient_agent_ids** | **Vec<String>** | The IDs of the agents to wait for. | 
