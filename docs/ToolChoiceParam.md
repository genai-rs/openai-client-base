...
| ToolChoiceMcp | How the model should select which tool (or tools) to use when generating a response. See the &#x60;tools&#x60; parameter to see how to specify which tools the model can call.  |
| ToolChoiceOptions | How the model should select which tool (or tools) to use when generating a response. See the &#x60;tools&#x60; parameter to see how to specify which tools the model can call.  |
| ToolChoiceTypes | How the model should select which tool (or tools) to use when generating a response. See the &#x60;tools&#x60; parameter to see how to specify which tools the model can call.  |
