...
**domain_secrets** | Option<[**Vec<models::BetaContainerNetworkPolicyDomainSecretParam>**](BetaContainerNetworkPolicyDomainSecretParam.md)> | Optional domain-scoped secrets for allowlisted domains. | [optional]
