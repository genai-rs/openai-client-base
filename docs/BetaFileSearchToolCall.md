...
**results** | Option<[**Vec<models::BetaFileSearchToolCallResultsInner>**](BetaFileSearchToolCall_results_inner.md)> | The results of the file search tool call.  | [optional]
