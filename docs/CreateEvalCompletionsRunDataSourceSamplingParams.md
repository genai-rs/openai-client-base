...
**response_format** | Option<[**models::CreateEvalCompletionsRunDataSourceSamplingParamsResponseFormat**](CreateEvalCompletionsRunDataSource_sampling_params_response_format.md)> |  | [optional]
