...
**category_applied_input_types** | [**std::collections::HashMap<String, Vec<models::ModerationInputType>>**](Vec.md) | Which modalities of input are reflected by the score for each category. | 
