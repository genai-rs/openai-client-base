...
**output** | [**Vec<models::BetaFunctionShellCallOutputContentParam>**](BetaFunctionShellCallOutputContentParam.md) | Captured chunks of stdout and stderr output, along with their associated outcomes. | 
