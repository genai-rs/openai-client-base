...
**request_counts** | Option<[**serde_json::Value**](.md)> | Upstream schema 'BatchRequestCounts' was referenced but not defined; replaced with free-form object to avoid backfilling local definitions. | [optional]
